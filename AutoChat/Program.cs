...
namespace AutoChat
{
    class Program
    {
        ...
        static void setupMessages()
        {
            ...
            {
                "gj", "gj", "gj", "gj", "hll", "wp", "nice", "helal", "adamsin"
            };
            ...
            {
                "gl", "hf", "sa", "gl hf", "glhf", "iyi oyunlar", "sa beyler"
            };
            ...
            {
                "GG WP", "GJ", "ZAA", "REKT", "WOW", "GG", "XD"
            };

            Motivate = new List<string>
            {
                "gj team", "hll team", "helal team"
            };
